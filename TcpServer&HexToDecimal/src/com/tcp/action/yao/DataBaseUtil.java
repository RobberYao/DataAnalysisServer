...
public interface DataBaseUtil {
	...
	public ArrayList<String> quaryByParamter(String tableName, String startTime, String endTime);//选择时间、按表名查找时间（注：用于打印PDF时使用，查找lab_displayparamter* 表）
	...
	public void insertDisplayTable(String tableName,String inputTabName,String probNum, String createdon,String temperature, String humidity,List<Map<String, Double>> modify);//查询参数修改表后，修改校验值后传入display显示表中。
	...
	public void insertSumDisplayTable(String inputTabName,String probNum, String createdon,String temperature, String humidity,List<Map<String, Double>> modify);//插入数据至显示数据汇总表
