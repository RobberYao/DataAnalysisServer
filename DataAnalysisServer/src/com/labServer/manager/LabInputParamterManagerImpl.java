...
public class LabInputParamterManagerImpl implements LabInputParamterManager {
	...
	public void addListItemsToDiffInput(List<LabInputParamter> list) {
	...
	public static Double findAVGInputTemperature(LabInputParamter labInputParamter, String inputTable) {
		DbHandle con = DbServer.getSingleInstance().getConn();
		StatementHandle stmt;
		Double avgTemp = 0.0;
		try {
